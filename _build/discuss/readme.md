...
项目地址：[https://github.com/minlearn/apps/tree/master/_build/discuss](https://github.com/minlearn/apps/tree/master/_build/discuss)

演示与特性✨
-----


![](https://github.com/minlearn/apps/raw/master/_build/discuss/assets/discuss.png)
...
登你的github，然后点击 https://github.com/minlearn/apps/fork 把仓库fork到你的github帐号
...
### 第三步. 在你fork到的仓库里面运行名为builddiscuss的部署
...
```
{"sitetitle":"Discuss","dismissmessage":"第一款能在cf上运行的自建轻量联合主机社区程序,自带主机管理前端https://github.com/minlearn/apps/tree/master/_build/discuss, 相关咨询联系tg：https://t.me/minlearn_1keydd","public":"on"}
```
