...
mkdir -p /app/discuss
wget --no-check-certificate https://github.com/minlearn/apps/archive/refs/heads/master.tar.gz -O /tmp/apps.tar.gz
tar -xzvf /tmp/apps.tar.gz -C /app/discuss apps-master/_build/discuss --strip-components=3
